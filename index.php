        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <p class="img-rounded">FINAL PROJECT</p></a>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
                              ...
                              <li class="nav-item"><a href="admin/index.php" class="nav-link active">Login as Admin</a> </li>';
							}
						else
							{
        ...
        <section class="popular">
            <div class="container">
                ...
                <div class="row">
						...
						<?php 	
                        //displaying the Top Dishes of the month				
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                   <p>Poblacion, Trinidad, Bohol 6324.</p>
                                    <h5>Phone: +63 946 2494 191</a></h5> </div>
